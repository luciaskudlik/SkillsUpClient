    ...
    <div id="instructions-page">
      ...
      <div id="instructions-container">
        ...
        <ul>
          ...
          <li>
            Once you’ve signed up, you automatically have 50 credits in your
          ...
          <li>
            you can cancel you attendance at any time before the workshop and
          ...
          <li>
            In order to gain more credit you have to host your own workshop
            (which we highly encourage!)
          </li>
        </ul>

        <h3>How to Host you own workshop:</h3>
        <ul>
          <li>Click on one of the ‘host your own workshop’ buttons</li>
          <li>
            This will drop down a form which you will need to fill with all the
            details for this workshop.
          </li>
          <li>
            For every new workshop, you will be granted 30 credits/hour of the
            duration of the workshop. (If your workshop lasts 90min, you will
            receive 45 credits!)
          </li>
          <li>
